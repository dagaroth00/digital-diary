...
/*if (array_key_exists("name", $_COOKIE) && $_COOKIE ['name']) {
 ...
 if (array_key_exists("logout", $_GET)) {
    ...
    } else if ((array_key_exists("name", $_SESSION) AND $_SESSION['name']) OR (array_key_exists("name", $_COOKIE) AND $_COOKIE['name'])) {
...
<form method="POST" style="border:1px solid #ccc">
  <div class="container">
    ...
    <label>
      <input type="checkbox" checked="checked" name="stayLoggedIn" value="1" style="margin-bottom:15px"> Remember me
    </label>
